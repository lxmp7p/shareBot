...
def start_message(message):
		bot.send_message(message.chat.id, "Добро пожаловать! \nС помощью данного бота вы можете осуществлять поиск необходимых курсов, которые были загружены участниками нашего сообщества. \nДля добавление курса используйте команду /add 'URL' 'НАЗВАНИЕ' \nДля поиска курсов используйте команду /find 'НАЗВАНИЕ' \nПомочь в разработке можно тут: https://github.com/lxmp7p/shareBot \nДля связи: @lxmpt_p")
